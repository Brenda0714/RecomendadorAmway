...
export class CountriesComponent implements OnInit {
  ...
  countries2: Array<any> = [
    ...
    },
    {
        ...
        link: 'https://www.amway.com.mx/category/nutricion&utm_source=recomendador&utm_medium=countries&utm_campaign=mx_site_recomendador&utm_content=cta_comprar&utm_term=nutricion'
    },
    {
